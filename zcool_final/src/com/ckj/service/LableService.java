...
public class LableService {
    ...
    public List<Lable> getLableThemes() {
        Set<String> indexSortByTheme = redis.smembers("theme");
        List<Lable> lableList = new ArrayList<>();
        for (String theme : indexSortByTheme) {
            Lable lable = new Lable();
            lable.setTheme(theme);
            lableList.add(lable);
        }
        return lableList;
    }
    ...
    public List<Lable> orderByView() {
        Set<String> indexSortByView = redis.zrange("indexSortByView", -100, -1);
    ...
    public List<Lable> orderByGood() {
        Set<String> indexSortByGood = redis.zrange("indexSortByGood", -100, -1);
    ...
    public List<Lable> orderByDegree() {
        Set<String> indexSortByDegree = redis.zrange("indexSortByDegree", -100, -1);
